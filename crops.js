...
const CROPS = [
...

  {
    ...
    tareas: [
      ...
      { id: 'acolchado',  day: 2,  cat: 'manejo',         titulo: 'Poner acolchado + goteo',
        detalle: 'Acolchado (plástico o paja) + riego por goteo debajo = tu palanca #1 de rendimiento (hasta ~60 t/ha). Ahorra agua, corta malezas y mantiene la hoja seca (menos hongos).' },
