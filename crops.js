...
const CROPS = [
  {
    ...
    tareas: [
      ...
      { id: 'raleofruto', day: 60, cat: 'manejo',         titulo: 'Dejar pocos frutos por planta (opcional)',
        detalle: 'Opcional: deja 2 a 4 zapallos por planta y quita el resto; así los que quedan crecen más grandes. Ponles paja o plástico debajo para que no se pudra la parte que toca el suelo.' },
